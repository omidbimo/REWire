...
class Object0x0005_Services(CIP_Services):
    pass
...
class ConnectionInstanceType(Enum_):
    EXPLICIT_MESSAGING = 0
    IO_MESSAGING = 1
    CIP_BRIGED = 2

class TransportClass(Enum_):
    CLASS0 = 0
    CLASS1 = 1
    CLASS2 = 2
    CLASS3 = 3

class ProductionTrigger(Enum_):
    CYCLIC = 0
    CHANGE_OF_STATE = 1
    APPLICATION_OBJECT = 2

class TransportDirection(Enum_):
    CLIENT = 0
    SERVER = 1
